...
const labelName = "Auto-Reply Mail";
...
app.get("/", async (req, res) => {
  ...
  const auth = await authenticate({
    keyfilePath: path.join(__dirname, "googleauth.json"),
    scopes: SCOPES,
  });
              ...
              resource: {
                raw: Buffer.from(
                  `To: ${
                    ...
                    `Thank you for your email. I'm currently on vacation, please contact me later.\r\n`
                ).toString("base64"),
              },
            };
